...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("C:/ESPHomeBuild/esp32-s3-box-3/build/bootloader/esp-idf/cmake_install.cmake")
endif()

string(REPLACE ";" "\n" CMAKE_INSTALL_MANIFEST_CONTENT
       "${CMAKE_INSTALL_MANIFEST_FILES}")
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "C:/ESPHomeBuild/esp32-s3-box-3/build/bootloader/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "C:/ESPHomeBuild/esp32-s3-box-3/build/bootloader/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
